...
| λ=0.10 (retune) | b | coa_phase | 0.000 | +0.00011 | 0.930 | PASS |
| λ=0.10 (retune) | b | polarization_angle | 0.950 | +0.00326 | 0.421 | FAIL |
| λ=0.10 (retune) | a | coa_phase | 0.425 | -0.00453 | 0.546 | FAIL |
| λ=0.10 (retune) | a | polarization_angle | 0.650 | +0.00220 | 0.559 | FAIL |

**Overall verdict — round under test (λ=0.10 (retune)), all 4 readings must pass: FAIL — UNINTERPRETABLE**
