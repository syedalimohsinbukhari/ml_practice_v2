"""Shared matplotlib style for publication-ready figures across experiments/.

Import explicitly where needed (``from experiments.plot_style import update_style``)
rather than relying on package import order -- this module is intentionally not
wired into experiments/__init__.py so that importing an experiment script does not
force a matplotlib import as a side effect for scripts that never plot anything.
"""
